...
#line 116 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_128_gatedTierB.slang"
...
#line 144 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_128_gatedTierB.slang"
...
#line 470
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, d_2 * 128U + idx_0), cload_0(tmpl_0, t_7 * 128U + idx_0));
...
#line 508
                    uint m_0 = d_3 % _S25;
                    want_1[d_3] = _S21 * 128U + (lane_0 * _S26 + j_2) * 8U + m_0;
...
#line 783
        thread array<float2, int(16)> _S41 = dreg_1;

#line 783
        filterOne_0(_S39, _S37, _S40, tid_1, &_S41, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
