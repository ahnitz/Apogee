...
#line 508
                    uint m_1 = d_3 % _S19;
                    want_2[d_3] = _S29 * 256U + (lane_1 * _S33 + j_2) * 16U + m_1;
...
#line 772
        dreg_1[n2_1] = cload_0(data_1, _S42 * 4096U + tid_1 + 256U * n2_1);
...
#line 783
        filterOne_0(_S44, _S42, _S45, tid_1, &_S46, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
