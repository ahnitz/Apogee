...
#line 310
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S20 * 4096U + idx_0), cload_0(tmpl_0, _S21 * 4096U + idx_0));
...
#line 337
                    uint m_0 = d_2 % _S23;
                    want_1[d_2] = _S26 * 256U + _S27 + _S25 * d_2;
...
#line 337
                    uint m_1 = d_2 % _S19;
                    want_2[d_2] = _S29 * 256U + (_S30 * _S31 + j_2) * 16U + m_1;
...
#line 336
                exchange_0(&r_4, &_S35, _S18, lgTB_1, kernelContext_3);
...
#line 525
            uint o_0 = pair_1 * (&kernelContext_4)->entryPointParams_0->nbins_0 + b_5;
            *((&kernelContext_4)->entryPointParams_peakIdx_0+o_0) = int(-1);

#line 526
            *((&kernelContext_4)->entryPointParams_peakVal_0+o_0) = packed_float2(float2(0.0f, 0.0f)) ;
