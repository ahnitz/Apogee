...
#line 388
            uint _S28 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 438
        dreg_1[n2_1] = cload_0(data_0, _S32 * 256U + tid_1 + 16U * n2_1);
...
#line 440
        filterOne_0(_S34, _S32, _S35, tid_1, &_S36, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
