...
#line 142 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_fusedTierB_c16.slang"
...
#line 168 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_fusedTierB_c16.slang"
...
#line 519
                half2 _S15 = stgGet_0((i_3 - _S13) * 16U + (b_4 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S15;
...
#line 613
                    uint m_0 = d_2 % _S20;
                    want_1[d_2] = _S16 * 256U + (lane_0 * _S21 + j_1) * 16U + m_0;
...
#line 649
        r_5[n2_0] = cmulConj_0((*dreg_0)[n2_0], cload_0(tmpl_0, t_6 * 256U + tid_1 + 16U * n2_0));
