...
#line 508
                    uint m_0 = d_3 % _S21;
                    want_1[d_3] = _S17 * 64U + (lane_0 * _S22 + j_1) * 4U + m_0;
...
#line 772
        dreg_1[n2_1] = cload_0(data_1, _S31 * 64U + tid_1 + 4U * n2_1);
...
#line 783
        filterOne_0(_S33, _S31, _S34, tid_1, &_S35, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
