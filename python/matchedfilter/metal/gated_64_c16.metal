...
#line 112 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_gatedTierB_c16.slang"
...
#line 133 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_gatedTierB_c16.slang"
...
#line 326
                    float ang_0 = 6.28318548202514648f * float(_S18 * k2_1) / 64.0f;
...
#line 336
                    uint m_0 = d_3 % _S19;
                    want_1[d_3] = _S17 * 64U + (_S18 * _S20 + j_1) * 4U + m_0;
...
#line 405
        uint _S26 = max(bestBits_0, myMag_0[i_5]);
...
#line 408
        uint _S28 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0])), wm_0, memory_order_relaxed);
...
#line 478
        dreg_1[n2_1] = cload_0(data_0, _S29 * 64U + tid_1 + 4U * n2_1);
...
#line 480
        filterOne_0(_S31, _S29, _S32, tid_1, &_S33, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
