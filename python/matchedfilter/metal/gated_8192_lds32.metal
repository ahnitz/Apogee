...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_8192_gatedTierB_lds32.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_8192_gatedTierB_lds32.slang"
...
#line 173
                float2 _S17 = stgGet_0((i_2 - _S15) * 512U + (b_3 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S23 * 8192U + idx_0))) , float2(*(tmpl_0+(_S24 * 8192U + idx_0))) );
...
#line 246
                    float ang_0 = 6.28318548202514648f * float(_S25 * k2_1) / 8192.0f;
...
#line 256
                    uint m_0 = d_2 % _S26;
                    want_1[d_2] = _S29 * 512U + _S30 + _S28 * d_2;
...
#line 246
                    float ang_1 = 6.28318548202514648f * float(_S32 * k2_1) / 512.0f;
...
#line 256
                    uint m_1 = d_2 % _S20;
                    want_2[d_2] = _S35 * 32U + _S36 + _S34 * d_2;
...
#line 246
                    float ang_2 = 6.28318548202514648f * float(_S39 * k2_1) / 32.0f;
...
#line 256
                    uint m_2 = d_2 % _S22;
                    want_3[d_2] = _S38 * 32U + (_S39 * _S40 + j_3) * 2U + m_2;
...
#line 296
            uint _S47 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_4]])), myMag_0[i_4], memory_order_relaxed);
...
#line 306
            uint _S48 = max(bestBits_0, myMag_0[i_4]);
...
#line 317
            ...
            *(peakIdx_0+o_1) = int(slotToIndex_0(tid_0 * 16U + i_4));

#line 318
            *(peakVal_0+o_1) = packed_float2(r_4[i_4]) ;
...
#line 377
        _S51 = best_0 >= (entryPointParams_1->rawThr_0);
