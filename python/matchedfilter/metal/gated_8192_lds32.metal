...
#line 116 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_8192_gatedTierB_lds32.slang"
...
#line 144 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_8192_gatedTierB_lds32.slang"
...
#line 470
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, d_2 * 8192U + idx_0), cload_0(tmpl_0, t_6 * 8192U + idx_0));
...
#line 508
                    uint m_0 = d_3 % _S26;
                    want_1[d_3] = _S29 * 512U + _S30 + _S28 * d_3;
...
#line 508
                    uint m_1 = d_3 % _S20;
                    want_2[d_3] = _S37 * 32U + _S38 + _S36 * d_3;
...
#line 507
                exchange_0(&r_4, &_S39, _S19, lgTB_1, kernelContext_3);
...
#line 495
                    r_4[k2_1] = cmul_0(r_4[k2_1], float2(cr_0, ci_0));
                    float nr_2 = cr_0 * _S41 - ci_0 * _S42;
...
#line 504
                uint _S44 = 16U / _S22;
                uint _S45 = max(0U, 1U);
                uint _S46 = tid_0 / _S45;

#line 506
                uint _S47 = tid_0 % _S45;
...
#line 508
                    uint m_2 = d_3 % _S22;
                    want_3[d_3] = _S40 * 32U + (lane_2 * _S44 + j_3) * 2U + m_2;
...
#line 507
                thread array<uint, int(16)> _S48 = want_3;

#line 507
                exchange_0(&r_4, &_S48, _S21, lgTB_2, kernelContext_3);
...
#line 562
            uint _S51 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 577
            uint _S52 = max(bestBits_0, myMag_0[i_5]);
...
#line 580
            uint _S54 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0])), wm_0, memory_order_relaxed);
...
#line 783
        uint _S57 = pair_1 + k_0;

#line 783
        uint _S58 = _S56 + k_0;

#line 783
        thread array<float2, int(16)> _S59 = dreg_1;

#line 783
        filterOne_0(_S57, _S55, _S58, tid_1, &_S59, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
...
#line 854
            if(b_8 < ((&kernelContext_5)->entryPointParams_0->nbins_0))
            {
            }
            else
            {
...
#line 855
            uint o_3 = pair_2 * (&kernelContext_5)->entryPointParams_0->nbins_0 + b_8;
