...
#line 116 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_8192_refineListed_lds32.slang"
...
#line 144 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_8192_refineListed_lds32.slang"
...
#line 485
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S23 * 8192U + idx_0), cload_0(tmpl_0, _S24 * 8192U + idx_0));
...
#line 519
                uint _S28 = max(512U, 1U);

#line 519
                uint _S29 = 16U / _S28;
                uint _S30 = max(32U, 1U);
...
#line 523
                    uint m_0 = d_2 % _S28;
                    want_1[d_2] = _S31 * 512U + _S32 + _S30 * d_2;
...
#line 510
                    r_4[k2_1] = cmul_0(r_4[k2_1], float2(cr_0, ci_0));
                    float nr_1 = cr_0 * _S34 - ci_0 * _S35;
...
#line 520
                _S22 = _S38;
                uint _S39 = tid_0 / _S38;

#line 521
                uint _S40 = tid_0 % _S38;
...
#line 523
                    uint m_1 = d_2 % _S20;
                    want_2[d_2] = _S39 * 32U + _S40 + _S38 * d_2;
...
#line 522
                thread array<uint, int(16)> _S41 = want_2;

#line 522
                exchange_0(&r_4, &_S41, _S19, lgTB_1, kernelContext_3);
...
#line 510
                    r_4[k2_1] = cmul_0(r_4[k2_1], float2(cr_0, ci_0));
                    float nr_2 = cr_0 * _S43 - ci_0 * _S44;
                    float _S45 = cr_0 * _S44 + ci_0 * _S43;
...
#line 519
                uint _S46 = 16U / _S22;
                uint _S47 = max(0U, 1U);
                uint _S48 = tid_0 / _S47;

#line 521
                uint _S49 = tid_0 % _S47;
...
#line 523
                    uint m_2 = d_2 % _S22;
                    want_3[d_2] = _S42 * 32U + (lane_2 * _S46 + j_3) * 2U + m_2;
...
#line 522
                thread array<uint, int(16)> _S50 = want_3;

#line 522
                exchange_0(&r_4, &_S50, _S21, lgTB_2, kernelContext_3);
...
#line 577
            uint _S53 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 595
            uint _S56 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0])), wm_0, memory_order_relaxed);
