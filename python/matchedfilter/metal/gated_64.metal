...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_gatedTierB.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_gatedTierB.slang"
...
#line 173
                float2 _S17 = stgGet_0((i_2 - _S15) * 4U + (b_3 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 229
        uint idx_0 = tid_0 + 4U * n2_0;
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S19 * 64U + idx_0))) , float2(*(tmpl_0+(_S20 * 64U + idx_0))) );
...
#line 246
                    float ang_0 = 6.28318548202514648f * float(_S22 * k2_1) / 64.0f;
...
#line 256
                    uint m_0 = d_2 % _S23;
                    want_1[d_2] = _S21 * 64U + (_S22 * _S24 + j_1) * 4U + m_0;
...
#line 296
            uint _S31 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_4]])), myMag_0[i_4], memory_order_relaxed);
...
#line 306
            uint _S32 = max(bestBits_0, myMag_0[i_4]);
...
#line 308
            uint _S34 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[int(0)])), wm_0, memory_order_relaxed);
...
#line 377
        _S35 = best_0 >= (entryPointParams_1->rawThr_0);
...
#line 379
            uint o_3 = pair_1 * (&kernelContext_4)->entryPointParams_0->nbins_0 + b_6;
