...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_1024_gatedTierB.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_1024_gatedTierB.slang"
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S21 * 1024U + idx_0))) , float2(*(tmpl_0+(_S22 * 1024U + idx_0))) );
...
#line 256
                    uint m_0 = d_2 % _S24;
                    want_1[d_2] = _S27 * 64U + _S28 + _S26 * d_2;
...
#line 256
                    uint m_1 = d_2 % _S20;
                    want_2[d_2] = _S30 * 64U + (_S31 * _S32 + j_2) * 4U + m_1;
