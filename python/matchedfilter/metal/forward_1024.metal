...
#line 336 "/tmp/tmp8xzv16fo/forward.slang"
...
#line 175 "/tmp/tmp8xzv16fo/forward.slang"
...
#line 1158 "/tmp/tmp8xzv16fo/forward.slang"
    return;
}
...
#line 1178
            x_2 = float2(*((&kernelContext_4)->entryPointParams_series_0+(_S36 + offset_0))) ;
...
#line 1178
        ...
        r_5[k_0] = float2(x_2.x / 1024.0f, - x_2.y / 1024.0f);
...
#line 1183
        *((&kernelContext_4)->entryPointParams_spectra_0+(_S35 * 1024U + slotToIndex_0(tid_1 * 16U + k_0))) = packed_float2(float2(r_5[k_0].x, - r_5[k_0].y)) ;
