...
#line 116 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_16384_refineListed_lds32.slang"
...
#line 144 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_16384_refineListed_lds32.slang"
...
#line 519
                uint _S28 = max(1024U, 1U);

#line 519
                uint _S29 = 16U / _S28;
                uint _S30 = max(64U, 1U);
...
#line 523
                    uint m_0 = d_2 % _S28;
                    want_1[d_2] = _S31 * 1024U + _S32 + _S30 * d_2;
...
#line 523
                    uint m_1 = d_2 % _S20;
                    want_2[d_2] = _S39 * 64U + _S40 + _S38 * d_2;
...
#line 523
                    uint m_2 = d_2 % _S22;
                    want_3[d_2] = _S42 * 64U + (lane_2 * _S46 + j_3) * 4U + m_2;
