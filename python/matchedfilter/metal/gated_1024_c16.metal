...
#line 112 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_1024_gatedTierB_c16.slang"
...
#line 138 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_1024_gatedTierB_c16.slang"
...
#line 462
        r_4[n2_0] = cmulConj_0((*dreg_0)[n2_0], cload_0(tmpl_0, t_7 * 1024U + tid_0 + 64U * n2_0));
...
#line 477
                    float ang_0 = 6.28318548202514648f * float(_S19 * k2_1) / 1024.0f;
...
#line 487
                    uint m_0 = d_3 % _S20;
                    want_1[d_3] = _S23 * 64U + _S24 + _S22 * d_3;
...
#line 477
                    float ang_1 = 6.28318548202514648f * float(_S27 * k2_1) / 64.0f;
...
#line 487
                    uint m_1 = d_3 % _S18;
                    want_2[d_3] = _S26 * 64U + (_S27 * _S28 + j_2) * 4U + m_1;
...
#line 750
        dreg_1[n2_1] = cload_0(data_0, _S37 * 1024U + tid_1 + 64U * n2_1);
...
#line 758
        filterOne_0(_S39, _S37, _S40, tid_1, &_S41, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
