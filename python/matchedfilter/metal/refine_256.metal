...
#line 519
                float2 _S17 = stgGet_0((i_3 - _S15) * 16U + (b_4 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 613
                    uint m_0 = d_2 % _S22;
                    want_1[d_2] = _S18 * 256U + (lane_0 * _S23 + j_1) * 16U + m_0;
...
#line 656
        ...
        r_5[n2_0] = cmulConj_0(cload_0(data_0, _S29 * 256U + idx_0), cload_0(tmpl_0, _S30 * 256U + idx_0));
...
#line 708
            uint _S33 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 726
            uint _S36 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0])), wm_0, memory_order_relaxed);
