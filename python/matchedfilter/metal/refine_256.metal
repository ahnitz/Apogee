...
#line 149 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_refineListed.slang"
...
#line 177 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_refineListed.slang"
...
#line 44
                    uint m_0 = d_2 % _S23;
                    want_1[d_2] = _S19 * 256U + (lane_0 * _S24 + j_1) * 16U + m_0;
...
#line 584 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_refineListed.slang"
    return;
}
...
#line 625
        ...
        r_5[n2_0] = cmulConj_0(cload_0(data_0, _S30 * 256U + idx_0), cload_0(tmpl_0, _S31 * 256U + idx_0));
...
#line 678
            uint _S35 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 693
            uint _S36 = max(winner_0, myMag_0[i_5]);
...
#line 754
                uint _S42 = atomic_fetch_min_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_5]])), tid_1 * 16U + i_5, memory_order_relaxed);
...
#line 765
                uint _S43 = pair_0 * nbins_1 + b_5;

#line 765
                *(peakIdx_0+_S43) = int(-1);

#line 765
                *(peakVal_0+_S43) = packed_float2(float2(0.0f, 0.0f)) ;
