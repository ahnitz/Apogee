...
#line 112 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_fusedTierB_c16.slang"
...
#line 133 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_fusedTierB_c16.slang"
...
#line 337
                    float ang_1 = 6.28318548202514648f * float(_S21 * k2_1) / 2048.0f;
...
#line 347
                    uint m_0 = d_3 % _S22;
                    want_1[d_3] = _S25 * 128U + _S26 + _S24 * d_3;
...
#line 337
                    float ang_2 = 6.28318548202514648f * float(_S29 * k2_1) / 128.0f;
...
#line 347
                    uint m_1 = d_3 % _S20;
                    want_2[d_3] = _S28 * 128U + (_S29 * _S30 + j_3) * 8U + m_1;
...
#line 346
                exchange_0(&r_4, &_S34, _S19, lgTB_1, kernelContext_3);
...
#line 388
            uint _S37 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_6]])), myMag_0[i_6], memory_order_relaxed);
...
#line 398
            uint _S38 = max(bestBits_0, myMag_0[i_6]);
...
#line 438
        dreg_1[n2_1] = cload_0(data_0, _S41 * 2048U + tid_1 + 128U * n2_1);
