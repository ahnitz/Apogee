...
#line 142 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_fusedTierB_c16.slang"
...
#line 168 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_fusedTierB_c16.slang"
...
#line 513
            stgPut_0(j_0 * 128U + kernelContext_2->_tid_0, (*r_2)[c_1 * 16U + j_0], kernelContext_2);
...
#line 355
void dft8_0(array<half2, int(16)> thread* r_3, uint o_0)
{
...
#line 365
            half2 t_6 = cmul_0(half2(half(cos(ang_0)), half(sin(ang_0))), (*r_3)[_S16 + 4U]);
            uint _S17 = ((j_1 - k_0) << 1U) + k_0;

#line 366
            b_5[_S17] = (*r_3)[_S16] + t_6;

#line 366
            b_5[_S17 + s_0] = (*r_3)[_S16] - t_6;
...
#line 613
                    uint m_0 = d_2 % _S23;
                    want_1[d_2] = _S26 * 128U + _S27 + _S25 * d_2;
...
#line 613
                    uint m_1 = d_2 % _S19;
                    want_2[d_2] = _S29 * 128U + (lane_1 * _S33 + j_3) * 8U + m_1;
...
#line 612
                exchange_0(r_5, &_S37, _S18, lgTB_1, kernelContext_3);
...
#line 649
        r_6[n2_0] = cmulConj_0((*dreg_0)[n2_0], cload_0(tmpl_0, t_7 * 2048U + tid_1 + 128U * n2_0));
...
#line 690
        ...
        float _rx_0 = float(r_6[i_6].x);

#line 694
        float _ry_0 = float(r_6[i_6].y);
        if(live_0)
        {
...
#line 748
            live_0 = ((*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0]) == myMag_0[i_6];
...
#line 754
            *(peakIdx_0+pair_0) = int(slotToIndex_0(tid_1 * 16U + i_6));

#line 754
            *(peakVal_0+pair_0) = packed_float2(float2(float(r_6[i_6].x), float(r_6[i_6].y))) ;
...
#line 919
        dreg_1[n2_1] = cload_0(data_1, _S43 * 2048U + tid_2 + 128U * n2_1);
...
#line 930
        filterOne_0(_S45, _S43, _S46, tid_2, &_S47, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_5);
