...
#line 133 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_512_gatedTierB_c16.slang"
...
#line 310
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S19 * 512U + idx_0), cload_0(tmpl_0, _S20 * 512U + idx_0));
...
#line 327
                    float ang_0 = 6.28318548202514648f * float(_S21 * k2_1) / 512.0f;
...
#line 337
                    uint m_0 = d_2 % _S22;
                    want_1[d_2] = _S25 * 32U + _S26 + _S24 * d_2;
...
#line 327
                    float ang_1 = 6.28318548202514648f * float(_S29 * k2_1) / 32.0f;
...
#line 337
                    uint m_1 = d_2 % _S18;
                    want_2[d_2] = _S28 * 32U + (_S29 * _S30 + j_2) * 2U + m_1;
