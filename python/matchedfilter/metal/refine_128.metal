...
#line 116 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_128_refineListed.slang"
...
#line 144 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_128_refineListed.slang"
...
#line 523
                    uint m_0 = d_2 % _S27;
                    want_1[d_2] = _S23 * 128U + (lane_0 * _S28 + j_2) * 8U + m_0;
...
#line 577
            uint _S35 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_6]])), myMag_0[i_6], memory_order_relaxed);
