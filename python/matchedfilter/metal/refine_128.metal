...
#line 146 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_128_refineListed.slang"
...
#line 174 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_128_refineListed.slang"
...
#line 513
            stgPut_0(j_0 * 8U + kernelContext_2->_tid_0, (*r_2)[c_1 * 16U + j_0], kernelContext_2);
...
#line 355
void dft8_0(array<float2, int(16)> thread* r_3, uint o_0)
{
...
#line 365
            float2 t_6 = cmul_0(float2(cos(ang_0), sin(ang_0)), (*r_3)[_S18 + 4U]);
            uint _S19 = ((j_1 - k_0) << 1U) + k_0;

#line 366
            b_5[_S19] = (*r_3)[_S18] + t_6;

#line 366
            b_5[_S19 + s_0] = (*r_3)[_S18] - t_6;
...
#line 613
                    uint m_0 = d_2 % _S24;
                    want_1[d_2] = _S20 * 128U + (lane_0 * _S25 + j_2) * 8U + m_0;
...
#line 656
        ...
        r_6[n2_0] = cmulConj_0(cload_0(data_0, _S31 * 128U + idx_0), cload_0(tmpl_0, _S32 * 128U + idx_0));
...
#line 690
        ...
        float _rx_0 = r_6[i_6].x;

#line 694
        float _ry_0 = r_6[i_6].y;
        if(live_0)
        {
...
#line 708
            uint _S35 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_6]])), myMag_0[i_6], memory_order_relaxed);
...
#line 723
            uint _S36 = max(bestBits_0, myMag_0[i_6]);
...
#line 751
            live_0 = ((*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_6]]) == myMag_0[i_6];
...
#line 754
            *(peakVal_0+o_1) = packed_float2(float2(r_6[i_6].x, r_6[i_6].y)) ;
...
#line 766
        if(((*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + b_7]) == thrBits_1)
        {
