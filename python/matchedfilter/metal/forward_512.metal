...
#line 333 "/tmp/tmp8kn86d61/forward.slang"
...
#line 172 "/tmp/tmp8kn86d61/forward.slang"
...
#line 517
                float2 _S13 = stgGet_0((i_2 - _S11) * 32U + (b_2 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S13;
...
#line 44
                    uint m_0 = d_2 % _S19;
                    want_1[d_2] = _S22 * 32U + _S23 + _S21 * d_2;
...
#line 44
                    uint m_1 = d_2 % _S15;
                    want_2[d_2] = _S25 * 32U + (lane_1 * _S29 + j_2) * 2U + m_1;
...
#line 1149 "/tmp/tmp8kn86d61/forward.slang"
    return;
}
...
#line 1169
        ...
        r_5[k_0] = float2(x_1.x / 512.0f, - x_1.y / 512.0f);
...
#line 1174
        *((&kernelContext_4)->entryPointParams_spectra_0+(_S35 * 512U + slotToIndex_0(tid_1 * 16U + k_0))) = packed_float2(float2(r_5[k_0].x, - r_5[k_0].y)) ;
