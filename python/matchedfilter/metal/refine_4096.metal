...
#line 146 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_4096_refineListed.slang"
...
#line 174 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_4096_refineListed.slang"
...
#line 519
                float2 _S17 = stgGet_0((i_3 - _S15) * 256U + (b_4 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 613
                    uint m_1 = d_2 % _S19;
                    want_2[d_2] = _S29 * 256U + (lane_1 * _S33 + j_2) * 16U + m_1;
...
#line 656
        ...
        r_5[n2_0] = cmulConj_0(cload_0(data_0, _S39 * 4096U + idx_0), cload_0(tmpl_0, _S40 * 4096U + idx_0));
