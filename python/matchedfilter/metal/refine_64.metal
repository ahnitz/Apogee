...
#line 116 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_64_refineListed.slang"
...
#line 144 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_64_refineListed.slang"
...
#line 523
                    uint m_0 = d_2 % _S25;
                    want_1[d_2] = _S21 * 64U + (lane_0 * _S26 + j_1) * 4U + m_0;
...
#line 577
            uint _S33 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
