...
#line 149 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_refineListed.slang"
...
#line 177 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_refineListed.slang"
...
#line 44
                    uint m_0 = d_2 % _S22;
                    want_1[d_2] = _S18 * 64U + (lane_0 * _S23 + j_1) * 4U + m_0;
...
#line 584 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_refineListed.slang"
    return;
}
...
#line 625
        uint idx_0 = tid_1 + 4U * n2_0;
        r_5[n2_0] = cmulConj_0(cload_0(data_0, _S29 * 64U + idx_0), cload_0(tmpl_0, _S30 * 64U + idx_0));
...
#line 678
            uint _S34 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 693
            uint _S35 = max(winner_0, myMag_0[i_5]);
...
#line 696
            uint _S37 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0])), wm_0, memory_order_relaxed);
...
#line 727
            uint _S39 = atomic_fetch_min_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + 1U])), waveWinner_0, memory_order_relaxed);
...
#line 733
            uint _S40 = tid_1 * 16U + i_5;

#line 733
            if(_S40 == (*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + 1U])
            {
...
#line 754
                uint _S41 = atomic_fetch_min_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_5]])), tid_1 * 16U + i_5, memory_order_relaxed);
...
#line 765
                uint _S42 = pair_0 * nbins_1 + b_6;

#line 765
                *(peakIdx_0+_S42) = int(-1);

#line 765
                *(peakVal_0+_S42) = packed_float2(float2(0.0f, 0.0f)) ;
