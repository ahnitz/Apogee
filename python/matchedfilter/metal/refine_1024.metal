...
#line 116 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_1024_refineListed.slang"
...
#line 144 "/tmp/mf-committed-check/python/matchedfilter/metal/mm_1024_refineListed.slang"
...
#line 485
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S21 * 1024U + idx_0), cload_0(tmpl_0, _S22 * 1024U + idx_0));
...
#line 523
                    uint m_0 = d_2 % _S26;
                    want_1[d_2] = _S29 * 64U + _S30 + _S28 * d_2;
...
#line 523
                    uint m_1 = d_2 % _S20;
                    want_2[d_2] = _S32 * 64U + (lane_1 * _S36 + j_2) * 4U + m_1;
...
#line 522
                exchange_0(&r_4, &_S40, _S19, lgTB_1, kernelContext_3);
