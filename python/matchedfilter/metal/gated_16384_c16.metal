...
#line 310
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S21 * 16384U + idx_0), cload_0(tmpl_0, _S22 * 16384U + idx_0));
...
#line 337
                    uint m_1 = d_2 % _S18;
                    want_2[d_2] = _S33 * 64U + _S34 + _S32 * d_2;
...
#line 337
                    uint m_2 = d_2 % _S20;
                    want_3[d_2] = _S36 * 64U + (_S37 * _S38 + j_3) * 4U + m_2;
...
#line 525
            uint o_1 = pair_1 * (&kernelContext_4)->entryPointParams_0->nbins_0 + b_6;
            *((&kernelContext_4)->entryPointParams_peakIdx_0+o_1) = int(-1);

#line 526
            *((&kernelContext_4)->entryPointParams_peakVal_0+o_1) = packed_float2(float2(0.0f, 0.0f)) ;
