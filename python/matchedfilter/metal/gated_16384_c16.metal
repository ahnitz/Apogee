...
#line 138 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_16384_gatedTierB_c16.slang"
...
#line 508
                    uint m_1 = d_3 % _S18;
                    want_2[d_3] = _S35 * 64U + _S36 + _S34 * d_3;
...
#line 507
                exchange_0(&r_4, &_S37, _S17, lgTB_1, kernelContext_3);
...
#line 495
                    r_4[k2_1] = cmul_0(r_4[k2_1], half2(half(cr_0), half(ci_0)));
                    float nr_2 = cr_0 * _S39 - ci_0 * _S40;
                    float _S41 = cr_0 * _S40 + ci_0 * _S39;
...
#line 504
                uint _S42 = 16U / _S20;
                uint _S43 = max(0U, 1U);
                uint _S44 = tid_0 / _S43;

#line 506
                uint _S45 = tid_0 % _S43;
...
#line 508
                    uint m_2 = d_3 % _S20;
                    want_3[d_3] = _S38 * 64U + (lane_2 * _S42 + j_3) * 4U + m_2;
...
#line 507
                thread array<uint, int(16)> _S46 = want_3;

#line 507
                exchange_0(&r_4, &_S46, _S19, lgTB_2, kernelContext_3);
...
#line 772
        dreg_1[n2_1] = cload_0(data_1, _S51 * 16384U + tid_1 + 1024U * n2_1);
...
#line 783
        filterOne_0(_S53, _S51, _S54, tid_1, &_S55, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
...
#line 855
            uint o_1 = pair_2 * (&kernelContext_5)->entryPointParams_0->nbins_0 + b_6;
