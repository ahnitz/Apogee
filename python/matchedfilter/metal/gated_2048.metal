...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_gatedTierB.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_gatedTierB.slang"
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S23 * 2048U + idx_0))) , float2(*(tmpl_0+(_S24 * 2048U + idx_0))) );
...
#line 296
            uint _S41 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 377
        _S45 = best_0 >= (entryPointParams_1->rawThr_0);
