...
#line 116 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_gatedTierB.slang"
...
#line 144 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_2048_gatedTierB.slang"
...
#line 470
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, d_2 * 2048U + idx_0), cload_0(tmpl_0, t_7 * 2048U + idx_0));
...
#line 508
                    uint m_0 = d_3 % _S26;
                    want_1[d_3] = _S29 * 128U + _S30 + _S28 * d_3;
...
#line 495
                    r_4[k2_1] = cmul_0(r_4[k2_1], float2(cr_0, ci_0));
                    float nr_1 = cr_0 * _S33 - ci_0 * _S34;
                    float _S35 = cr_0 * _S34 + ci_0 * _S33;
...
#line 508
                    uint m_1 = d_3 % _S22;
                    want_2[d_3] = _S32 * 128U + (lane_1 * _S36 + j_3) * 8U + m_1;
...
#line 507
                thread array<uint, int(16)> _S40 = want_2;

#line 507
                exchange_0(&r_4, &_S40, _S21, lgTB_1, kernelContext_3);
...
#line 562
            uint _S43 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_6]])), myMag_0[i_6], memory_order_relaxed);
...
#line 580
            uint _S46 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0])), wm_0, memory_order_relaxed);
...
#line 768
    uint _S47 = pair_1 / ntmpl_1;

#line 768
    uint _S48 = pair_1 % ntmpl_1;
...
#line 783
        uint _S49 = pair_1 + k_1;

#line 783
        uint _S50 = _S48 + k_1;

#line 783
        thread array<float2, int(16)> _S51 = dreg_1;

#line 783
        filterOne_0(_S49, _S47, _S50, tid_1, &_S51, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
