...
#line 112 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_4096_fusedTierB_c16.slang"
...
#line 133 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_4096_fusedTierB_c16.slang"
...
#line 337
                    float ang_0 = 6.28318548202514648f * float(_S20 * k2_2) / 4096.0f;
...
#line 347
                    uint m_0 = d_3 % _S21;
                    want_1[d_3] = _S24 * 256U + _S25 + _S23 * d_3;
...
#line 337
                    float ang_1 = 6.28318548202514648f * float(_S28 * k2_2) / 256.0f;
                    r_4[k2_2] = cmul_0(r_4[k2_2], half2(half(cos(ang_1)), half(sin(ang_1))));
...
#line 347
                    uint m_1 = d_3 % _S19;
                    want_2[d_3] = _S27 * 256U + (_S28 * _S29 + j_2) * 16U + m_1;
...
#line 346
                exchange_0(&r_4, &_S33, _S18, lgTB_1, kernelContext_3);
...
#line 388
            uint _S36 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0 + myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
...
#line 398
            uint _S37 = max(bestBits_0, myMag_0[i_5]);
...
#line 400
            uint _S39 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[kernelContext_3->_stgBase_0])), wm_0, memory_order_relaxed);
...
#line 410
            *(peakVal_0+o_0) = packed_float2(float2(float(r_4[i_5].x), float(r_4[i_5].y))) ;
...
#line 438
        dreg_1[n2_1] = cload_0(data_0, _S40 * 4096U + tid_1 + 256U * n2_1);
...
#line 440
        uint _S42 = pair_1 + k_0;

#line 440
        uint _S43 = _S41 + k_0;

#line 440
        thread array<half2, int(16)> _S44 = dreg_1;

#line 440
        filterOne_0(_S42, _S40, _S43, tid_1, &_S44, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_4);
