...
#line 519
                half2 _S15 = stgGet_0((i_3 - _S13) * 256U + (b_4 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S15;
...
#line 613
                    uint m_0 = d_2 % _S21;
                    want_1[d_2] = _S24 * 256U + _S25 + _S23 * d_2;
...
#line 613
                    uint m_1 = d_2 % _S17;
                    want_2[d_2] = _S27 * 256U + (lane_1 * _S31 + j_2) * 16U + m_1;
...
#line 649
        r_5[n2_0] = cmulConj_0((*dreg_0)[n2_0], cload_0(tmpl_0, t_6 * 4096U + tid_1 + 256U * n2_0));
...
#line 919
        dreg_1[n2_1] = cload_0(data_1, _S41 * 4096U + tid_2 + 256U * n2_1);
