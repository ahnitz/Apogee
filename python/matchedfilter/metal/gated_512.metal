...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_512_gatedTierB.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_512_gatedTierB.slang"
...
#line 173
                float2 _S17 = stgGet_0((i_2 - _S15) * 32U + (b_3 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S21 * 512U + idx_0))) , float2(*(tmpl_0+(_S22 * 512U + idx_0))) );
...
#line 246
                    float ang_0 = 6.28318548202514648 * float(_S23 * k2_1) / 512.0;
...
#line 246
                    float ang_1 = 6.28318548202514648 * float(_S31 * k2_1) / 32.0;
...
#line 296
            uint _S39 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_4]])), myMag_0[i_4], memory_order_relaxed);
...
#line 306
            uint _S40 = max(bestBits_0, myMag_0[i_4]);
...
#line 377
        _S43 = best_0 >= (entryPointParams_1->rawThr_0);
