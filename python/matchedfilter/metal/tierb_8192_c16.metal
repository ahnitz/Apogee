...
#line 138 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_8192_fusedTierB_c16.slang"
...
#line 508
                    uint m_1 = d_3 % _S18;
                    want_2[d_3] = _S35 * 32U + _S36 + _S34 * d_3;
...
#line 508
                    uint m_2 = d_3 % _S20;
                    want_3[d_3] = _S38 * 32U + (lane_2 * _S42 + j_3) * 2U + m_2;
...
#line 772
        dreg_1[n2_1] = cload_0(data_1, _S51 * 8192U + tid_1 + 512U * n2_1);
