...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_gatedTierB.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_256_gatedTierB.slang"
...
#line 173
                float2 _S18 = stgGet_0((i_2 - _S16) * 16U + (b_3 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S18;
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S20 * 256U + idx_0))) , float2(*(tmpl_0+(_S21 * 256U + idx_0))) );
...
#line 246
                    float ang_0 = 6.28318548202514648 * float(_S23 * k2_2) / 256.0;
...
#line 296
            uint _S32 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_4]])), myMag_0[i_4], memory_order_relaxed);
...
#line 306
            uint _S33 = max(bestBits_0, myMag_0[i_4]);
...
#line 327
            *(peakVal_0+o_1) = packed_float2(float2(0.0, 0.0)) ;
...
#line 380
            *((&kernelContext_4)->entryPointParams_peakVal_0+o_2) = packed_float2(float2(0.0, 0.0)) ;
