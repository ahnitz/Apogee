...
#line 71 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_16384_gatedTierB_lds32.slang"
...
#line 60 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_16384_gatedTierB_lds32.slang"
...
#line 173
                float2 _S17 = stgGet_0((i_2 - _S15) * 1024U + (b_3 << lgSpan_0) + ln_0, kernelContext_2);
                out_0[d_1] = _S17;
...
#line 229
        ...
        r_4[n2_0] = cmulConj_0(float2(*(data_0+(_S23 * 16384U + idx_0))) , float2(*(tmpl_0+(_S24 * 16384U + idx_0))) );
...
#line 246
                    float ang_0 = 6.28318548202514648 * float(_S25 * k2_1) / 16384.0;
...
#line 246
                    float ang_1 = 6.28318548202514648 * float(_S32 * k2_1) / 1024.0;
...
#line 246
                    float ang_2 = 6.28318548202514648 * float(_S39 * k2_1) / 64.0;
