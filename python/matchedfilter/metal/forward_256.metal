...
#line 333 "/tmp/tmp2zmsgc9w/forward.slang"
...
#line 172 "/tmp/tmp2zmsgc9w/forward.slang"
...
#line 1149 "/tmp/tmp2zmsgc9w/forward.slang"
    return;
}
...
#line 1163
    uint _S27 = entryPointParams_starts_1[_S26];
...
#line 1166
        ...
        float2 _S28 = float2(0.0f, 0.0f);

#line 1167
        bool _S29;

        if(_S27 < ((&kernelContext_4)->entryPointParams_0->seriesLength_0))
        {

#line 1169
            _S29 = offset_0 < ((&kernelContext_4)->entryPointParams_0->seriesLength_0 - _S27);
...
#line 1169
            x_0 = float2(*((&kernelContext_4)->entryPointParams_series_0+(_S27 + offset_0))) ;
...
#line 1169
        ...
        r_5[k_0] = float2(x_0.x / 256.0f, - x_0.y / 256.0f);
...
#line 1174
        *((&kernelContext_4)->entryPointParams_spectra_0+(_S26 * 256U + slotToIndex_0(tid_1 * 16U + k_0))) = packed_float2(float2(r_5[k_0].x, - r_5[k_0].y)) ;
