...
#line 708
            uint _S43 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + myBin_0[i_6]])), myMag_0[i_6], memory_order_relaxed);
...
#line 766
        if(((*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + b_8]) == thrBits_1)
        {

#line 767
            uint o_3 = pair_0 * nbins_1 + b_8;

            *(peakIdx_0+o_3) = int(-1);

#line 769
            *(peakVal_0+o_3) = packed_float2(float2(0.0f, 0.0f)) ;
