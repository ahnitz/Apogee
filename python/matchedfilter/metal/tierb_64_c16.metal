...
#line 93 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_fusedTierB_c16.slang"
...
#line 100 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_fusedTierB_c16.slang"
...
#line 207
            stgPut_0(j_0 * 4U + kernelContext_2->_tid_0, float2((*r_1)[c_1 * 16U + j_0]), kernelContext_2);
...
#line 269
        ...
        r_4[n2_0] = cmulConj_0(cload_0(data_0, _S19 * 64U + idx_0), cload_0(tmpl_0, _S20 * 64U + idx_0));
...
#line 337
            uint _S31 = atomic_fetch_max_explicit(((atomic_uint threadgroup*)(&(*kernelContext_3->stg_0)[myBin_0[i_5]])), myMag_0[i_5], memory_order_relaxed);
