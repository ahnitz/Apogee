...
#line 145 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_fusedTierB_c16.slang"
...
#line 171 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_fusedTierB_c16.slang"
...
#line 584 "/home/ahnitz/projects/claude/searchdev/work/peak-fft/python/matchedfilter/metal/mm_64_fusedTierB_c16.slang"
    return;
}
...
#line 618
        r_5[n2_0] = cmulConj_0((*dreg_0)[n2_0], cload_0(tmpl_0, t_7 * 64U + tid_1 + 4U * n2_0));
...
#line 727
        uint _S32 = atomic_fetch_min_explicit(((atomic_uint threadgroup*)(&(*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + 1U])), waveWinner_0, memory_order_relaxed);
...
#line 733
        uint _S33 = tid_1 * 16U + i_5;

#line 733
        if(_S33 == (*kernelContext_4->stg_0)[kernelContext_4->_stgBase_0 + 1U])
        {
...
#line 930
        dreg_1[n2_1] = cload_0(data_1, _S34 * 64U + tid_2 + 4U * n2_1);
...
#line 941
        thread array<half2, int(16)> _S38 = dreg_1;

#line 941
        filterOne_0(_S36, _S34, _S37, tid_2, &_S38, data_1, tmpl_1, peakIdx_1, peakVal_1, winStart_2, winEnd_2, binsize_2, binShift_2, nbins_2, thrBits_2, kernelContext_5);
