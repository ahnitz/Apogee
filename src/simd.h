...
#define V_STREAM(p,v)   _mm512_stream_ps(p,v)
#define VQ_STREAM(p,v)  _mm512_stream_si512((__m512i*)(p),v)
...
#define V_STREAM(p,v)   _mm256_stream_ps(p,v)
#define VQ_STREAM(p,v)  _mm256_stream_si256((__m256i*)(p),v)
